...
if (count($_POST) > 0) {
    ...
    if ($_POST['tipoPeticion'] === 'crearPaciente') {
        ...
        $inserccionPaciente = crearInsert('pacientes', 'numero_documento,nombres,apellidoUno,apellidoDos,fecha_nacimiento,fecha_inicio_tratamiento,telefono,sexo, otrosAntecedentesFamiliares, codigo_residencia_FK,codigo_tipo_documento_FK', [
            $numeroDocumento, $nombre, $apellido1, $apellido2, $fechaNacimiento, $fechaInicioTratamiento, $telefono, $sexo, $otrosAntecedentesFamiliares,
